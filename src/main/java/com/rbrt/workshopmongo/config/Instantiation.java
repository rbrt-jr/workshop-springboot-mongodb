package com.rbrt.workshopmongo.config;
...
import com.rbrt.workshopmongo.dto.AuthorDTO;
import com.rbrt.workshopmongo.dto.CommentDTO;
import com.rbrt.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveite!", sdf.parse("22/04/2018"), new AuthorDTO(bob));
